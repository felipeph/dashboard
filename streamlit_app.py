...
header_center_col.markdown("""<div align="left"><h1 style="color:#2A4B80; display: inline">ACODATA®</h1><h4 style="color:#2A4B80; display: inline">CÓDIGO: 645205</h4></div>""", unsafe_allow_html=True)
